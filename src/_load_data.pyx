...
def load_aln(str aln, float max_gap_fraction=0.9):
    cdef str line
    cdef list parsed
    cdef float gap_fraction
    cdef dict mapping = {'-': 21, 'A': 1, 'B': 21, 'C': 2, 'D': 3, 'E': 4, 'F': 5,
...
def load_fasta(str fasta, float max_gap_fraction=0.9):
    cdef str line
    cdef list parsed
    cdef float gap_fraction
    cdef dict mapping = {'-': 21, 'A': 1, 'B': 21, 'C': 2, 'D': 3, 'E': 4, 'F': 5,
...
def load_a3m(str fasta, float max_gap_fraction=0.9):
    cdef str line
    cdef list parsed
    cdef float gap_fraction
    cdef dict mapping = {'-': 21, 'A': 1, 'B': 21, 'C': 2, 'D': 3, 'E': 4, 'F': 5,
